<ul class="breadcrumb">
    ...
    <li><?php echo $this->Html->link(__('Dados da Unidade'), array('action' => 'view', $this->data['Unit']['id'])); ?> <span class="divider">/</span></li>
...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="well">
            ...
            <?php echo $this->Form->create('Unit', array('action' => 'delete', $this->data['Unit']['id'])); ?>
