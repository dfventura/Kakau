<ul class="breadcrumb">
    <li><?php echo $this->Html->link(__('Produto'), array('action' => 'index')); ?> <span class="divider">/</span></li>
    <li><?php echo $this->Html->link(__('Dados do produto'), array('action' => 'view', $this->data['Product']['id'])); ?> <span class="divider">/</span></li>
